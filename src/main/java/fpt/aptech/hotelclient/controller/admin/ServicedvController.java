...
//        model.addAttribute("servicedv", new ServicedvDto());
...
//
//            ServicedvDto product = new ServicedvDto();
//
...
//            restTemplate.postForEntity(createUrl, product, ServicedvDto.class);
...
//        ServicedvDto serviceDetails = restTemplate.getForObject(apiUrl + "edit/" + id, ServicedvDto.class);
...
//            ServicedvDto originalService = restTemplate.getForObject(detailsUrl, ServicedvDto.class);
//
...
//                    originalService.setImage(multipartFile);
//                }
//            }
//
...
//        try {
//            ResponseEntity<ServicedvDto[]> responseEntity = restTemplate.getForEntity(apiUrl + "search?name=" + name, ServicedvDto[].class);
//            List<ServicedvDto> searchedServices = Arrays.asList(responseEntity.getBody());
